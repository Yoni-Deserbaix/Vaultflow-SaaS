  ...
  return (
    <div className="mt-28 text-center max-md:mt-12">
      <Button
        ...
        className="hover:none mx-auto flex max-w-[417px] cursor-auto justify-center border-opacity-30 py-2.5 max-sm:max-w-80 max-sm:text-xs max-sm:mx-auto max-sm:p-1.5"
        invert
      ></Button>
      <h1 className="m-7 text-7xl font-medium text-[#ECECEC] max-md:m-4 max-md:mx-4 max-md:text-4xl">
        Modern analytics <br />
        <span className="bg-gradient-to-r from-[#ecececbe] to-[#ececec5c] bg-clip-text text-transparent">
          for the modern world
        </span>
      </h1>
      <p className="text-lg font-light text-[#ECECECA6] opacity-95 max-md:text-xs max-md:mx-4">
